...
### Changed
- Frontend keeps prior data on partial API failures and shows inline error banner
- Status badge now labels inactive/idle based on inactivity color
- Backend tolerates missing/unreadable arpwatch log directory when parsing events
